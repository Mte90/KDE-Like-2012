...
function bones_scripts_and_styles() {
  if (!is_admin()) {
    ...
    wp_register_style( 'bones-stylesheet', get_stylesheet_directory_uri() . '/library/app.css', array(), '', 'all' );
    /* MODIFICATO
    wp_register_script( 'bones-lesscss', get_stylesheet_directory_uri() . '/library/js/less-1.3.0.min.js', array(), '1.3.0', false );
    ...
    /* MODIFICATO */
    wp_enqueue_script( 'bones-lesscss' );
...
function bones_main_nav() {
    ...
    wp_nav_menu(array(
    	...
    	'menu' => 'Menu',                      // nav name
    	'menu_class' => 'nav nav-top clearfix',         // adding custom nav class
